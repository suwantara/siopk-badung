...
@section('content')
<x-ui.back-link href="{{ route('admin.opk.show', $laporan) }}" label="Kembali ke Detail" />
    ...
    <div class="col-12 col-md-8">
        <div class="card">
            <div class="card-header-custom">
                ...
                <span style="color:var(--abu)" class="t-caption">{{ $laporan->kode_laporan }}</span>
            </div>
            <div class="card-body">
                {{-- Validation Error Summary --}}
                @if($errors->any())
                <div class="alert alert-danger py-2 px-3 mb-3" class="t-body">
                ...
                <form method="POST" action="{{ route('admin.opk.update', $laporan) }}" id="form-update-opk" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Nama OPK <span style="color:var(--merah)">*</span></label>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Kondisi <span style="color:var(--merah)">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Status Pelindungan <span style="color:var(--merah)">*</span></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Deskripsi Umum <span style="color:var(--merah)">*</span></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Sejarah & Asal-Usul</label>
                        <textarea name="sejarah_asal_usul" class="form-control" rows="3">{{ old('sejarah_asal_usul', $laporan->sejarah_asal_usul) }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Nilai & Makna Budaya</label>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Latitude (GPS)</label>
                            <input type="text" name="latitude" class="form-control"
                                   value="{{ old('latitude', $laporan->latitude) }}" placeholder="-8.xxxxxx">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">Longitude (GPS)</label>
                    ...
                    <div class="mb-4">
                        <label class="form-label mb-2" style="font-weight:600;text-transform:uppercase;letter-spacing:0.06em;" class="t-caption">
                            Foto (<span id="foto-count">{{ $fotoCount }}</span>/10)
                        </label>

                        @if($laporan->fotos->count() > 0)
                        <div style="display:flex;flex-wrap:wrap;margin-bottom:12px" class="gap-sm">
                            ...
                            <div style="position:relative;width:100px;height:100px;border-radius:4px;overflow:hidden;border:2px solid {{ $foto->is_utama ? 'var(--emas)' : 'var(--garis)' }};">
                                ...
                                @if($foto->is_utama)
                                <span style="position:absolute;bottom:0;left:0;right:0;background:var(--emas);color:white;text-align:center;padding:1px 0" class="t-caption">UTAMA</span>
                                @else
                        ...
                        @else
                        <p style="color:var(--abu);margin-bottom:12px" class="t-body">Belum ada foto.</p>
                        @endif
                        ...
                        <small id="foto-quota-warn" class="text-danger" style="display:none;margin-left:8px" class="t-caption">Maksimal 10 foto tercapai</small>
                        @error('fotos')<div class="text-danger" class="t-caption">{{ $message }}</div>@enderror
                        @error('fotos.*')<div class="text-danger" class="t-caption">{{ $message }}</div>@enderror
                        <div id="foto-preview" style="display:flex;flex-wrap:wrap;margin-top:8px" class="gap-sm"></div>
