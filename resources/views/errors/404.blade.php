...
<div style="max-width:500px;margin:4rem auto;text-align:center;padding:2rem;">
    ...
    <p style="color:var(--abu-gelap);margin-bottom:1.5rem" class="t-body-lg">Halaman yang Anda cari tidak dapat ditemukan. Mungkin telah dipindahkan, dihapus, atau alamat yang dimasukkan kurang tepat.</p>
