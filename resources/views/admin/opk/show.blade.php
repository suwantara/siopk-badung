        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="d-flex gap-3 align-items-start">
                    ...
                    <a href="{{ route('admin.opk.edit', $laporan) }}" class="btn-edit btn-sm">
                    ...
                    <form method="POST" action="{{ route('admin.opk.destroy', $laporan) }}"
                        ...
                        @csrf @method('DELETE')
                        <button type="submit" class="btn btn-sm btn-outline-danger" style="white-space:nowrap;" title="Arsipkan OPK">
