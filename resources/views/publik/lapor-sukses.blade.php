    ...
    <div class="sukses-card">
        ...
        <div class="sukses-body">
            ...
            <div class="d-flex gap-3">
                <a href="{{ route('publik.lapor.index') }}" class="btn-emas" style="flex:1;text-align:center;justify-content:center;">
                    <i class="bi bi-plus-circle me-1"></i>Lapor OPK Lain
                </a>
                <a href="{{ route('publik.lapor.status') }}?kode_laporan={{ $laporan->kode_laporan }}"
                   class="btn btn-outline-secondary" style="flex:1;text-align:center;justify-content:center;">
